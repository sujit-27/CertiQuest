...
public class KafkaConfig {
    ...
    public ProducerFactory<String, QuizEvent> producerFactory() {
        ...
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "maglev.proxy.rlwy.net:53982");
    ...
    public ConsumerFactory<String, QuizEvent> consumerFactory() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "maglev.proxy.rlwy.net:53982");
