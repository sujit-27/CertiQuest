...
public class KafkaConfig {
    ...
    public ProducerFactory<String, QuizEvent> producerFactory() {
        ...
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka-production-6b2f.up.railway.app:29092");
    ...
    public ConsumerFactory<String, QuizEvent> consumerFactory() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka-production-6b2f.up.railway.app:29092");
