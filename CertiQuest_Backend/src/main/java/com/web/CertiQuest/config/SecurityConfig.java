        ...
        http
            .cors(cors -> {
                ...
                config.setAllowedOrigins(List.of(
                        "https://certi-quest-kohl.vercel.app",
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/", "/api/v1.0/webhooks/**", "/api/quiz/**", "/api/quiz",
                        "/api/certificates/**", "/api/certificates/download/**",
                        "/api/leaderboard/**", "/api/fcm/**").permitAll()
