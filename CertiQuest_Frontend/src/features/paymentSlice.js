...
export const initiatePayment = createAsyncThunk(
  ...
  async ({ plan, name, email, getToken, isSignedIn }, { dispatch, rejectWithValue }) => {
    try {
      ...
      const response = await axios.post("https://certiquest.onrender.com/api/payments/create-order", {
        planId: plan.id,
...
export const verifyPayment = createAsyncThunk(
  ...
  async ({ response, plan, getToken, isSignedIn }, { dispatch, rejectWithValue }) => {
    try {
      const token = await getToken();
      const verifyResponse = await axios.post('https://certiquest.onrender.com/api/payments/verify-payment', {
