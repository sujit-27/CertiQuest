            ...
            <div className='relative'>
                <div className='text-center'>
                    ...
                    <p className='mt-4 max-w-3xl mx-auto text-xl text-gray-500'>
                        Hear from students, professionals, and trainers who have leveled up their skills with CertiQuest.
                    </p>
                </div>
                            ...
                            <div className='p-8'>
                                ...
                                <div className='mt-4 flex items-center'>
                                    {[...Array(5)].map((_, i) => (
                                        <Star key={i} 
                                            size={16}
                                            className={`${i < testimonial.rating ? 'text-orange-400' : 'text-gray-300'} fill-current`}/>
                                    ))}
                                </div>
